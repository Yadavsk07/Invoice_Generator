...
function InvoiceForm({ onSave }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMeta({ invoiceNumber: "", invoiceDate: "", dueDate: "", paymentTerms: "", currency: "USD", taxRatePercent: 0, discountPercent: 0, discountAmount: 0, paymentInstructions: "", terms: "", thanks: "" });
            ...
            <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Textarea id="paymentInstructions" rows={3} name="paymentInstructions" onChange={handleMetaChange} value={meta.paymentInstructions} placeholder="e.g., Bank account / UPI details" />
                </div>
                <div>
                  <Label htmlFor="terms">Terms and conditions</Label>
                  <Textarea id="terms" rows={3} name="terms" onChange={handleMetaChange} value={meta.terms} />
                </div>
                <div>
                  <Label htmlFor="thanks">Thank-you message</Label>
                  <Input id="thanks" name="thanks" value={meta.thanks} onChange={handleMetaChange} placeholder="Optional message to the client" />
                </div>
              </div>
            </div>
